  ...
  return (
    <footer className="w-full bg-white dark:bg-[#0F172A] border-t border-slate-200 dark:border-slate-900 mt-16 px-6 py-12 flex flex-col items-center justify-center transition-colors duration-200">
      <div className="w-full max-w-5xl flex flex-col">
        <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-8 pb-8 border-b border-slate-100 dark:border-slate-900/60">
          {/* Branding Técnico */}
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[10px] text-slate-400 dark:text-slate-500 leading-relaxed max-w-60">
              Simulador técnico interativo homologado para testes de Code
              Review, depuração em tempo real e avaliação de senioridade
              front-end.
            </p>
          </div>
